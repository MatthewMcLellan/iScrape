...
#Preview("Main storyboard – Initial (Map)") {
    // Preview the initial view controller in the Main storyboard.
    // If MapViewController is set as initial, this will render it.
    StoryboardViewControllerPreview("Main")
}

#Preview("Main storyboard – MapViewController by identifier") {
    // Preview MapViewController by storyboard identifier. If the identifier
    // is not set to "MapViewController", a friendly placeholder will appear.
    StoryboardViewControllerPreview("Main", identifier: "MapViewController")
}
